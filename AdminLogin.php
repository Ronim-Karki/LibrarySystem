...
<div class="box3">
    ...
    <h3>Admin login</h3>
        ...
        <p align="center" style="margin-left:-20px"><a href="Memberlogin.php">Member login</a></p>
 ...
 <?php
	...
	{
		$count=0;
		$res=mysqli_query($db,"SELECT * FROM admin where uname='$_POST[uname]' && psw='$_POST[psw]';");
		...
		else
		{
			...
			?>
            <script type="text/javascript">
				window.location="Admin/adminlogged.php"
			</script>
            <?php
		}
	}
